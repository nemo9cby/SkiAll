...
# Content scanning is intentionally NOT done here — source code that
# discusses tokens/secrets (docs, tests, schemas) would cause false
# positives. The .gitignore provides layer 2 protection.
